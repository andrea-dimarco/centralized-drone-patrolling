...
void System_updateBoundParameters_4(DATA *data, threadData_t *threadData);
...
int System_updateBoundParameters(DATA *data, threadData_t *threadData)
{
  ...
  (data->simulationInfo->integerParameter[2]/* cc.p.nAreas PARAM */)  = ((modelica_integer) 64);
  ...
  (data->simulationInfo->integerParameter[153]/* m.p.nAreas PARAM */)  = ((modelica_integer) 64);
  ...
  System_updateBoundParameters_2(data, threadData);
  System_updateBoundParameters_3(data, threadData);
  System_updateBoundParameters_4(data, threadData);
  System_updateBoundParameters_5(data, threadData);
  TRACE_POP
  return 0;
}
