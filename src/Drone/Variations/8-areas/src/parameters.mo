...
record Prm
	...
	parameter Real stop_simulation = 172800; // 14 hours // 2 days
	...
	parameter Integer nDrones = 4; // Number of uavs
	...
	parameter Real flyZone[3] = {200.0, 200.0, 200.0}; //i n meters
	...
	parameter Integer nAreas = 8;
	parameter Real areas[8,6] = {
		//l_x           u_x           l_y           u_y           l_z           u_z
		{ 0.0,          flyZone[1]/2, 0.0,          flyZone[2]/2, 0.0,          flyZone[3]/2 }, // 1
		{ flyZone[1]/2, flyZone[1],   0.0,          flyZone[2]/2, 0.0,          flyZone[3]/2 }, // 2
		{ 0.0,          flyZone[1]/2, flyZone[2]/2, flyZone[2],   0.0,          flyZone[3]/2 }, // 3
		{ flyZone[1]/2, flyZone[1],   flyZone[2]/2, flyZone[2],   0.0,          flyZone[3]/2 }, // 4
		{ 0.0,          flyZone[1]/2, 0.0,          flyZone[2]/2, flyZone[1]/2, flyZone[3]   }, // 5
		{ flyZone[1]/2, flyZone[1],   0.0,          flyZone[2]/2, flyZone[1]/2, flyZone[3]   }, // 6
		{ 0.0,          flyZone[1]/2, flyZone[2]/2, flyZone[2],   flyZone[1]/2, flyZone[3]   }, // 7
		{ flyZone[1]/2, flyZone[1],   flyZone[2]/2, flyZone[2],   flyZone[1]/2, flyZone[3]   }  // 8
	};
