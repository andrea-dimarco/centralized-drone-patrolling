...
void Prm_construct_p(threadData_t *threadData, void* v_ths ) {
  ...
  ths->_nDrones = ((modelica_integer) 1);
  ...
  array_alloc_scalar_real_array(&tmp2, 3, (modelica_real)200.0, (modelica_real)200.0, (modelica_real)200.0);
  real_array_copy_data(tmp2, ths->_flyZone);
  
  alloc_real_array(&(ths->_docking_bay), 1, (_index_t)3);
  array_alloc_scalar_real_array(&tmp3, 3, (modelica_real)-10.0, (modelica_real)-10.0, (modelica_real)-10.0);
  real_array_copy_data(tmp3, ths->_docking_bay);
  ...
  array_alloc_scalar_real_array(&tmp5, 6, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)0.0, (modelica_real)100.0);
  array_alloc_scalar_real_array(&tmp6, 6, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)0.0, (modelica_real)100.0);
  array_alloc_scalar_real_array(&tmp7, 6, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)0.0, (modelica_real)100.0);
  array_alloc_scalar_real_array(&tmp8, 6, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)0.0, (modelica_real)100.0);
  array_alloc_scalar_real_array(&tmp9, 6, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)100.0, (modelica_real)200.0);
  array_alloc_scalar_real_array(&tmp10, 6, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)100.0, (modelica_real)200.0);
  array_alloc_scalar_real_array(&tmp11, 6, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)100.0, (modelica_real)200.0);
  array_alloc_scalar_real_array(&tmp12, 6, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)100.0, (modelica_real)200.0);
  array_alloc_real_array(&tmp4, 8, tmp5, tmp6, tmp7, tmp8, tmp9, tmp10, tmp11, tmp12);
  real_array_copy_data(tmp4, ths->_areas);
