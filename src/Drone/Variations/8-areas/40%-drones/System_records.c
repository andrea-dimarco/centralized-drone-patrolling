...
void Prm_construct_p(threadData_t *threadData, void* v_ths ) {
  ...
  array_alloc_scalar_real_array(&tmp14, 3, (modelica_real)200.0, (modelica_real)200.0, (modelica_real)200.0);
  real_array_copy_data(tmp14, ths->_flyZone);
  
  alloc_real_array(&(ths->_docking_bay), 1, (_index_t)3);
  array_alloc_scalar_real_array(&tmp15, 3, (modelica_real)-10.0, (modelica_real)-10.0, (modelica_real)-10.0);
  real_array_copy_data(tmp15, ths->_docking_bay);
  ...
  array_alloc_scalar_real_array(&tmp17, 6, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)0.0, (modelica_real)100.0);
  array_alloc_scalar_real_array(&tmp18, 6, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)0.0, (modelica_real)100.0);
  array_alloc_scalar_real_array(&tmp19, 6, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)0.0, (modelica_real)100.0);
  array_alloc_scalar_real_array(&tmp20, 6, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)0.0, (modelica_real)100.0);
  array_alloc_scalar_real_array(&tmp21, 6, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)100.0, (modelica_real)200.0);
  array_alloc_scalar_real_array(&tmp22, 6, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)100.0, (modelica_real)200.0);
  array_alloc_scalar_real_array(&tmp23, 6, (modelica_real)0.0, (modelica_real)100.0, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)100.0, (modelica_real)200.0);
  array_alloc_scalar_real_array(&tmp24, 6, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)100.0, (modelica_real)200.0, (modelica_real)100.0, (modelica_real)200.0);
  array_alloc_real_array(&tmp16, 8, tmp17, tmp18, tmp19, tmp20, tmp21, tmp22, tmp23, tmp24);
  real_array_copy_data(tmp16, ths->_areas);
